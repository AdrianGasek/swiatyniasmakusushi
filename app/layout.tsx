...
export const metadata: Metadata = {
  ...
  description: "Zapraszamy do najlepszej sushi restauracji w mieście! Świeże składniki, autentyczne smaki Japonii i wykwintne sushi rolls, sashimi oraz nigiri. Odkryj wyjątkowe doznania kulinarne w przytulnej atmosferze. Zarezerwuj stolik już dziś!",
  keywords: [
    'sushi',
    'sushi warszawa',
    'sushi warsaw',
...
export default function RootLayout({
  ...
  return (
    <html lang="pl">
      ...
      <meta name="keywords" content="sushi, sushi warszawa, sushi warsaw, sushi rembertów, sushi warszawa rembertów, najlepsze sushi warszawa, sushi rolls, japanese food, japanese food warsaw, warsaw rembertów sushi, warsaw sushi" />
      </Head>
